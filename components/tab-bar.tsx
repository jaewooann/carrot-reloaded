...
import {
  ...
  ChatBubbleOvalLeftEllipsisIcon as SoildChatBubbleOvalLeftEllipsisIcon,
...
export default function TabBar() {
  ...
  return (
    <div className="fixed bg-neutral-800 bottom-0 w-full mx-auto max-w-screen-md grid grid-cols-5 border-neutral-600 border-t px-5 py-3 *:text-white">
      ...
      <Link href="/chat" className="flex flex-col items-center gap-px">
        {pathname === "/chat" ? (
          <SoildChatBubbleOvalLeftEllipsisIcon className="w-7 h-7" />
        ) : (
